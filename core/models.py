class Apartment():
    ...
    def compute_monthly_water_consumption(self):
        ...
        total_consumption = (self.default_water_consumption + self.additional_water_consumption)
    ...
    def compute_monthly_bill(self):
        ...
        corporation = Corporation(default_consumption*self.default_water_mix[0]/sum(self.default_water_mix))
        borewell = Borewell(default_consumption*self.default_water_mix[1]/sum(self.default_water_mix))
        total_bill = tanker.monthly_bill + corporation.monthly_bill + borewell.monthly_bill
...
class Tanker(Water):
    ...
    def __calculate_bill(self) -> None:
        ...
        if self.monthly_consumption <= 500:
            ...
            self.monthly_bill = ((500*2) + (1000*3) + (self.monthly_consumption-1500)*5)
        else:
            self.monthly_bill = ((500*2) + (1000*3) + (1500*5) + (self.monthly_consumption-3000)*8)
